...
REM
REM Generated by Vivado on Wed Mar 25 15:11:27 +0700 2026
...
echo "xvlog --incr --relax -prj m_top_vlog.prj"
call xvlog  --incr --relax -prj m_top_vlog.prj -log xvlog.log
