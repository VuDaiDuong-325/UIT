...
HD_PWD='D:/HK6/SoC_Design/BT/bt2004/mac_engine/mac_engine/mac_engine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_engine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mac_engine.tcl -notrace
