...
HD_PWD='D:/HK6/SoC_Design/BT/bt2004/mac_engine/mac_engine/mac_engine.runs/synth_1_copy_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_engine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mac_engine.tcl
