...
REM
REM Generated by Vivado on Fri Apr 24 00:04:52 +0700 2026
...
echo "xvlog --incr --relax -prj tb_mac_tvla_vlog.prj"
call xvlog  --incr --relax -prj tb_mac_tvla_vlog.prj -log xvlog.log
