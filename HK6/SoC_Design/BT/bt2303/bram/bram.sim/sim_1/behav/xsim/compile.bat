...
REM
REM Generated by Vivado on Sun Mar 29 22:22:14 +0700 2026
...
echo "xvlog --incr --relax -prj tb_dc_fifo_vlog.prj"
call xvlog  --incr --relax -prj tb_dc_fifo_vlog.prj -log xvlog.log
