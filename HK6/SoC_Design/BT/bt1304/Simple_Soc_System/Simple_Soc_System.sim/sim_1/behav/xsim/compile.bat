...
REM
REM Generated by Vivado on Sun Apr 19 19:06:22 +0700 2026
...
echo "xvlog --incr --relax -prj tb_apb_system_vlog.prj"
call xvlog  --incr --relax -prj tb_apb_system_vlog.prj -log xvlog.log
